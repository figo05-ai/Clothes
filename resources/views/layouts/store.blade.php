        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header border-bottom-0 pb-0">
                    <h5 class="modal-title fw-bold" id="modalOrderTrackingLabel">Track Your Order</h5>
                                    ...
                                    <div class="col-6 col-md-3">
                                        <div class="card border-0 shadow-sm h-100">
                                            <a href="/product/${product.slug}">
                                                <img src="${product.images && product.images.length > 0 ? product.images[0].image_path : 'https://via.placeholder.com/300x400'}" class="card-img-top" alt="${product.name}" style="height: 150px; object-fit: cover;">
                                            </a>
                                            <div class="card-body p-2 text-center">
                                                <h6 class="card-title mb-1" style="font-size:0.9rem;"><a href="/product/${product.slug}" class="text-dark text-decoration-none">${product.name}</a></h6>
                                                <p class="text-primary mb-0 fw-bold">$${product.base_price}</p>
                                            </div>
                                        </div>
                                    </div>
                                `;

            ...
            <div class="col-md-8 col-lg-9">
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <p class="text-muted mb-5" style="font-size: 0.95rem; line-height: 1.6;">Welcome to your personalized account dashboard. From here, you can seamlessly navigate through your recent orders, review your wishlist, and update your personal sizing and fit preferences.</p>
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('dashboard.orders') }}" class="text-decoration-none">
                                    <div class="p-4 rounded-4 border h-100 d-flex flex-column shadow-sm transition-all text-dark" style="background-color: #ffffff; transition: transform 0.2s ease, box-shadow 0.2s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 10px 20px rgba(0,0,0,0.05)';" onmouseout="this.style.transform='none'; this.style.boxShadow='0 0.125rem 0.25rem rgba(0, 0, 0, 0.075)';">
                                        ...
                                        <h5 class="fw-bold mb-2">Order History</h5>
                                        <p class="text-muted small mb-0 flex-grow-1">Check the status of your recent orders, view order details, and track shipments seamlessly.</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('dashboard.preferences') }}" class="text-decoration-none">
                                    <div class="p-4 rounded-4 border h-100 d-flex flex-column shadow-sm transition-all text-dark" style="background-color: #ffffff; transition: transform 0.2s ease, box-shadow 0.2s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 10px 20px rgba(0,0,0,0.05)';" onmouseout="this.style.transform='none'; this.style.boxShadow='0 0.125rem 0.25rem rgba(0, 0, 0, 0.075)';">
                                        ...
                                        <h5 class="fw-bold mb-2">My Preferences</h5>
                                        <p class="text-muted small mb-0 flex-grow-1">Update your sizing, style preferences, and personalized shopping recommendations.</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('wishlist') }}" class="text-decoration-none">
                                    <div class="p-4 rounded-4 border h-100 d-flex flex-column shadow-sm transition-all text-dark" style="background-color: #ffffff; transition: transform 0.2s ease, box-shadow 0.2s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 10px 20px rgba(0,0,0,0.05)';" onmouseout="this.style.transform='none'; this.style.boxShadow='0 0.125rem 0.25rem rgba(0, 0, 0, 0.075)';">
                                        ...
                                        <h5 class="fw-bold mb-2">My Wishlist</h5>
                                        <p class="text-muted small mb-0 flex-grow-1">Access your saved items, move them to your cart, or share them with friends.</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('returns') }}" class="text-decoration-none">
                                    <div class="p-4 rounded-4 border h-100 d-flex flex-column shadow-sm transition-all text-dark" style="background-color: #ffffff; transition: transform 0.2s ease, box-shadow 0.2s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 10px 20px rgba(0,0,0,0.05)';" onmouseout="this.style.transform='none'; this.style.boxShadow='0 0.125rem 0.25rem rgba(0, 0, 0, 0.075)';">
                                        ...
                                        <p class="text-muted small mb-0 flex-grow-1">Initiate a return, download shipping labels, and track your refund status.</p>
                                    </div>
                                </a>
                            </div>
                        </div>

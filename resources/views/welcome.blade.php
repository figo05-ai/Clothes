...
<body class="homepage">
    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasAccount"
        ...
        <div class="offcanvas-body p-4 d-flex flex-column">
            <div class="user-profile-header p-3 mb-4 rounded-3"
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="d-flex align-items-center gap-3">
                        <div class="avatar-upload-wrapper">
                            ...
                            <button type="button" class="avatar-camera-overlay"
                                onclick="openProfileTab('#tabPhoto')" title="Change Profile Photo">
                ...
                <div class="d-flex gap-2">
                    <button type="button"
                        ...
                        style="font-size: 0.75rem;" onclick="openProfileTab('#tabPhoto')">
                    ...
                    <button type="button"
                        ...
                        style="font-size: 0.75rem;" onclick="openProfileTab('#tabPersonal')">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2">
            ...
            <div class="account-menu-group mb-4">
                ...
                <div class="list-group list-group-flush border rounded-3 overflow-hidden">
                    <a href="#"
                        ...
                        data-bs-toggle="modal" data-bs-target="#modalSizing">
                        <span class="d-flex align-items-center gap-3">
                            <svg width="20" height="20" viewBox="0 0 24 24" class="text-primary">
                    ...
                    <a href="#"
                        class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3"
                        data-bs-toggle="modal" data-bs-target="#modalOrderTracking">
                        <span class="d-flex align-items-center gap-3">
                            <svg width="20" height="20" viewBox="0 0 24 24" class="text-primary">
                    ...
                    <a href="#"
                        class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3"
                        data-bs-toggle="modal" data-bs-target="#modalWishlist">
                        <span class="d-flex align-items-center gap-3">
                            <svg width="20" height="20" viewBox="0 0 24 24" class="text-primary">
                    ...
                    <a href="#"
                        class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3"
                        data-bs-toggle="modal" data-bs-target="#modalAddresses">
                        <span class="d-flex align-items-center gap-3">
                            <svg width="20" height="20" viewBox="0 0 24 24" class="text-primary">
            ...
            <div class="account-menu-group mb-4">
                <h6 class="text-uppercase text-muted mb-2 px-2" style="font-size: 0.75rem; letter-spacing: 1px;">
                    Support & Assistance</h6>
                <div class="list-group list-group-flush border rounded-3 overflow-hidden">
                    <a href="#"
                        class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3"
                        data-bs-toggle="modal" data-bs-target="#modalSupport">
                        <span class="d-flex align-items-center gap-3">
                            <svg width="20" height="20" viewBox="0 0 24 24" class="text-primary">
                    ...
                    <a href="#"
                        class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3"
                        data-bs-toggle="modal" data-bs-target="#modalReturns">
                        <span class="d-flex align-items-center gap-3">
                            <svg width="20" height="20" viewBox="0 0 24 24" class="text-primary">
            ...
            <div class="account-menu-group mb-4">
                ...
                <div class="list-group list-group-flush border rounded-3 overflow-hidden">
                    <a href="#"
                        class="list-group-item list-group-item-action d-flex align-items-center justify-content-between p-3 text-danger fw-medium"
                        ...
                        <svg width="16" height="16" viewBox="0 0 24 24" class="text-danger">
                            <use xlink:href="#arrow-right"></use>
                        </svg>
                    </a>
                </div>
            ...
            <div class="row justify-content-between align-items-center w-100">
                ...
                <div class="col-auto d-flex align-items-center gap-3">
                    <a href="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAccount"
                        aria-controls="offcanvasAccount" title="Side Menu"
                        class="d-flex align-items-center text-dark pe-2">
                    ...
                    <div class="swiper-wrapper d-flex">
                            ...
                            <div class="spotlight-card h-100 d-flex flex-column">
                                <div class="position-relative overflow-hidden">
                                    <a href="#new-arrival" class="d-block text-decoration-none">
                                        <img src="{{ asset('images/banner-image-6.jpg') }}" alt="Soft Leather Jackets"
                                            class="img-fluid w-100 spotlight-img">
                                    </a>
                                    <span
                                        class="badge bg-white text-dark rounded-pill position-absolute top-0 start-0 m-3 px-3 py-2 fw-semibold shadow-sm"
                                        style="font-size: 0.75rem;">GENUINE LEATHER</span>
                                </div>
                                <div class="p-4 d-flex flex-column flex-grow-1">
                                    <span class="text-uppercase text-primary fw-bold mb-1"
                                        style="font-size: 0.75rem; letter-spacing: 1.5px;">HAND-FINISHED</span>
                                    <h5 class="fw-bold text-dark text-uppercase mb-2" style="letter-spacing: 0.5px;">
                                        <a href="#new-arrival" class="text-decoration-none text-dark">Soft Leather
                                            Jackets</a>
                                    </h5>
                                    <p class="text-secondary mb-4 flex-grow-1"
                                        style="font-size: 0.9rem; line-height: 1.6;">
                                        Experience unmatched warmth and luxury with our supple, hand-finished genuine
                                        leather jackets.
                                    </p>
                                    <div>
                                        <a href="#new-arrival"
                        ...
                        <div class="swiper-slide">
                            <div class="spotlight-card h-100 d-flex flex-column">
                                <div class="position-relative overflow-hidden">
                                    <a href="#new-arrival" class="d-block text-decoration-none">
                                        <img src="{{ asset('images/banner-image-1.jpg') }}"
                                            alt="Tailored Winter Coats" class="img-fluid w-100 spotlight-img">
                                    </a>
                                    <span
                                        class="badge bg-white text-dark rounded-pill position-absolute top-0 start-0 m-3 px-3 py-2 fw-semibold shadow-sm"
                                        style="font-size: 0.75rem;">WOOL & CASHMERE</span>
                                </div>
                                <div class="p-4 d-flex flex-column flex-grow-1">
                                    <span class="text-uppercase text-primary fw-bold mb-1"
                                        style="font-size: 0.75rem; letter-spacing: 1.5px;">HERITAGE FIT</span>
                                    <h5 class="fw-bold text-dark text-uppercase mb-2" style="letter-spacing: 0.5px;">
                                        <a href="#new-arrival" class="text-decoration-none text-dark">Tailored Winter
                                            Coats</a>
                                    </h5>
                                    <p class="text-secondary mb-4 flex-grow-1"
                                        style="font-size: 0.9rem; line-height: 1.6;">
                                        Elevate your winter wardrobe with tailored silhouettes designed for supreme
                        ...
                        <div class="swiper-slide">
                            <div class="spotlight-card h-100 d-flex flex-column">
                                <div class="position-relative overflow-hidden">
                                    <a href="#new-arrival" class="d-block text-decoration-none">
                                        <img src="{{ asset('images/banner-image-2.jpg') }}"
                                            alt="Refined Evening Blazers" class="img-fluid w-100 spotlight-img">
                                    </a>
                                    <span
                                        class="badge bg-white text-dark rounded-pill position-absolute top-0 start-0 m-3 px-3 py-2 fw-semibold shadow-sm"
                                        style="font-size: 0.75rem;">EVENING EDITION</span>
                                </div>
                                <div class="p-4 d-flex flex-column flex-grow-1">
                                    <span class="text-uppercase text-primary fw-bold mb-1"
                                        style="font-size: 0.75rem; letter-spacing: 1.5px;">FINE MERINO</span>
                                    <h5 class="fw-bold text-dark text-uppercase mb-2" style="letter-spacing: 0.5px;">
                                        <a href="#new-arrival" class="text-decoration-none text-dark">Refined Evening
                                            Blazers</a>
                                    </h5>
                                    <p class="text-secondary mb-4 flex-grow-1"
                                        style="font-size: 0.9rem; line-height: 1.6;">
                                        Refined evening essentials and structured coats crafted from ultra-soft imported
                                        merino wool.
                                    </p>
                                    <div>
                                        <a href="#new-arrival"
                        ...
                        <div class="swiper-slide">
                            <div class="spotlight-card h-100 d-flex flex-column">
                                <div class="position-relative overflow-hidden">
                                    <a href="#new-arrival" class="d-block text-decoration-none">
                                        <img src="{{ asset('images/banner-image-3.jpg') }}" alt="Modern Trench Coats"
                                            class="img-fluid w-100 spotlight-img">
                                    </a>
                                    <span
                                        class="badge bg-white text-dark rounded-pill position-absolute top-0 start-0 m-3 px-3 py-2 fw-semibold shadow-sm"
                                        style="font-size: 0.75rem;">PARISIAN STYLE</span>
                                </div>
                                <div class="p-4 d-flex flex-column flex-grow-1">
                                    <span class="text-uppercase text-primary fw-bold mb-1"
                                        style="font-size: 0.75rem; letter-spacing: 1.5px;">WEATHERPROOF</span>
                                    <h5 class="fw-bold text-dark text-uppercase mb-2" style="letter-spacing: 0.5px;">
                                        <a href="#new-arrival" class="text-decoration-none text-dark">Modern Trench
                                            Coats</a>
                                    </h5>
                                    <p class="text-secondary mb-4 flex-grow-1"
                                        style="font-size: 0.9rem; line-height: 1.6;">
                                        Versatile and weather-resistant outerwear combining modern functionality with
                                        classic Parisian aesthetics.
                                    </p>
                                    <div>
                                        <a href="#new-arrival"
                                            class="btn btn-dark rounded-pill px-4 py-2 text-uppercase fw-semibold fs-7 shadow-sm d-inline-flex align-items-center gap-2">
                        ...
                        <div class="swiper-slide">
                            <div class="spotlight-card h-100 d-flex flex-column">
                                <div class="position-relative overflow-hidden">
                                    <a href="#new-arrival" class="d-block text-decoration-none">
                                        <img src="{{ asset('images/banner-image-4.jpg') }}" alt="Out Crop Sweater"
                                            class="img-fluid w-100 spotlight-img">
                                    </a>
                                    <span
                                        class="badge bg-white text-dark rounded-pill position-absolute top-0 start-0 m-3 px-3 py-2 fw-semibold shadow-sm"
                                        style="font-size: 0.75rem;">BREATHABLE KNIT</span>
                                </div>
                                <div class="p-4 d-flex flex-column flex-grow-1">
                                    <span class="text-uppercase text-primary fw-bold mb-1"
                                        style="font-size: 0.75rem; letter-spacing: 1.5px;">COTTON YARN</span>
                                    <h5 class="fw-bold text-dark text-uppercase mb-2" style="letter-spacing: 0.5px;">
                                        <a href="#new-arrival" class="text-decoration-none text-dark">Out Crop
                                            Sweater</a>
                                    </h5>
                                    <p class="text-secondary mb-4 flex-grow-1"
                                        style="font-size: 0.9rem; line-height: 1.6;">
                                        Cozy knitwear featuring relaxed cuts and breathable cotton-blend yarn for
                        ...
                        <div class="swiper-slide">
                            <div class="spotlight-card h-100 d-flex flex-column">
                                <div class="position-relative overflow-hidden">
                                    <a href="#new-arrival" class="d-block text-decoration-none">
                                        <img src="{{ asset('images/banner-image-5.jpg') }}" alt="Signature Outerwear"
                                            class="img-fluid w-100 spotlight-img">
                                    </a>
                                    <span
                                        class="badge bg-white text-dark rounded-pill position-absolute top-0 start-0 m-3 px-3 py-2 fw-semibold shadow-sm"
                                        style="font-size: 0.75rem;">TIMELESS STAPLES</span>
                                </div>
                                <div class="p-4 d-flex flex-column flex-grow-1">
                                    <span class="text-uppercase text-primary fw-bold mb-1"
                                        style="font-size: 0.75rem; letter-spacing: 1.5px;">ESSENTIAL LAYER</span>
                                    <h5 class="fw-bold text-dark text-uppercase mb-2" style="letter-spacing: 0.5px;">
                                        <a href="#new-arrival" class="text-decoration-none text-dark">Signature
                                            Outerwear</a>
                                    </h5>
                                    <p class="text-secondary mb-4 flex-grow-1"
                                        style="font-size: 0.9rem; line-height: 1.6;">
                                        Timeless outerwear staples engineered for durability, sophisticated layering,
                ...
                <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up" data-aos-delay="0">
                    <div class="feature-card h-100 d-flex flex-column align-items-center justify-content-between">
                        <div>
                            ...
                            <span class="text-uppercase text-primary fw-bold d-block mb-1"
                                style="font-size: 0.75rem; letter-spacing: 1.5px;">VIP CONSULTATION</span>
                            <h5 class="fw-bold text-dark text-uppercase mb-3" style="letter-spacing: 0.5px;">Book An
                                Appointment</h5>
                            <p class="text-secondary m-0" style="font-size: 0.9rem; line-height: 1.6;">
                                Schedule a complimentary one-on-one private styling consultation with our in-store
                                fashion experts.
                            </p>
                        </div>
                        <div class="pt-4">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#modalContact"
                                class="btn btn-sm btn-outline-dark rounded-pill px-3 py-1-5 fw-semibold text-uppercase"
                                style="font-size: 0.75rem; letter-spacing: 1px;">Reserve Session →</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up" data-aos-delay="200">
                    <div class="feature-card h-100 d-flex flex-column align-items-center justify-content-between">
                        <div>
                            ...
                            <span class="text-uppercase text-primary fw-bold d-block mb-1"
                                style="font-size: 0.75rem; letter-spacing: 1.5px;">EXPRESS BOUTIQUE</span>
                            <h5 class="fw-bold text-dark text-uppercase mb-3" style="letter-spacing: 0.5px;">Pick Up
                                In Store</h5>
                            <p class="text-secondary m-0" style="font-size: 0.9rem; line-height: 1.6;">
                                Enjoy fast, complimentary local pickup at our boutique locations within 2 hours of
                                placing your order.
                            </p>
                        </div>
                        <div class="pt-4">
                            <a href="#footer"
                                class="btn btn-sm btn-outline-dark rounded-pill px-3 py-1-5 fw-semibold text-uppercase"
                                style="font-size: 0.75rem; letter-spacing: 1px;">Find Store →</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up" data-aos-delay="400">
                    <div class="feature-card h-100 d-flex flex-column align-items-center justify-content-between">
                        <div>
                            ...
                            <span class="text-uppercase text-primary fw-bold d-block mb-1"
                                style="font-size: 0.75rem; letter-spacing: 1.5px;">SIGNATURE BOX</span>
                            <h5 class="fw-bold text-dark text-uppercase mb-3" style="letter-spacing: 0.5px;">Special
                                Packaging</h5>
                            <p class="text-secondary m-0" style="font-size: 0.9rem; line-height: 1.6;">
                                Every purchase is carefully wrapped in our signature eco-friendly gift boxes with
                                personalized care.
                            </p>
                        </div>
                        <div class="pt-4">
                            <span class="badge bg-light text-secondary border px-3 py-2 rounded-pill fw-semibold"
                                style="font-size: 0.75rem;">Included Free</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up" data-aos-delay="600">
                    <div class="feature-card h-100 d-flex flex-column align-items-center justify-content-between">
                        <div>
                            ...
                            <span class="text-uppercase text-primary fw-bold d-block mb-1"
                                style="font-size: 0.75rem; letter-spacing: 1.5px;">30-DAY GUARANTEE</span>
                            <h5 class="fw-bold text-dark text-uppercase mb-3" style="letter-spacing: 0.5px;">Free
                                Global Returns</h5>
                            <p class="text-secondary m-0" style="font-size: 0.9rem; line-height: 1.6;">
                                Shop with total confidence thanks to our hassle-free 30-day worldwide return and
                                exchange policy.
                            </p>
                        </div>
                        <div class="pt-4">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#modalContact"
                                class="btn btn-sm btn-outline-dark rounded-pill px-3 py-1-5 fw-semibold text-uppercase"
                                style="font-size: 0.75rem; letter-spacing: 1px;">Policy Info →</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="categories py-5 bg-white overflow-hidden">
        <div class="container py-3">
            ...
            <div class="text-center mb-5">
                <span class="text-uppercase text-primary fw-bold d-block mb-1"
                    style="font-size: 0.8rem; letter-spacing: 2.5px;">CURATED DEPARTMENTS</span>
                <h3 class="section-title text-uppercase m-0" style="font-weight: 700; letter-spacing: 1px;">DISCOVER
                    OUR COLLECTIONS</h3>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="category-card">
                        <a href="#new-arrival" class="d-block text-decoration-none text-white">
                            <img src="{{ asset('images/cat-item1.jpg') }}" alt="Shop for Men"
                                class="img-fluid w-100 category-card-img">
                            <!-- Item Badge -->
                            <span
                                class="badge bg-white text-dark rounded-pill position-absolute top-0 end-0 m-3 px-3 py-2 fw-semibold shadow-sm"
                                style="font-size: 0.75rem;">38 ITEMS</span>
                            <!-- Gradient Overlay & Content -->
                            <div
                                class="category-card-overlay position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-end p-4">
                                <span class="text-uppercase text-white-50 small fw-medium mb-1"
                                    style="letter-spacing: 1.5px;">TAILORED MENSWEAR</span>
                                <h4 class="fw-bold text-white text-uppercase m-0 mb-3 fs-3"
                                    style="letter-spacing: 1px;">Shop For Men</h4>
                                <div>
                                    <span
                                        class="btn btn-light rounded-pill px-4 py-2 text-uppercase fw-semibold fs-7 shadow-sm d-inline-flex align-items-center gap-2">
                                        Explore Department
                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor" stroke-width="2">
                                            <line x1="5" y1="12" x2="19" y2="12">
                ...
                <div class="col-md-4">
                    <div class="category-card">
                        <a href="#new-arrival" class="d-block text-decoration-none text-white">
                            <img src="{{ asset('images/cat-item2.jpg') }}" alt="Shop for Women"
                                class="img-fluid w-100 category-card-img">
                            <!-- Item Badge -->
                            <span
                                class="badge bg-white text-dark rounded-pill position-absolute top-0 end-0 m-3 px-3 py-2 fw-semibold shadow-sm"
                                style="font-size: 0.75rem;">54 ITEMS</span>
                            <!-- Gradient Overlay & Content -->
                            <div
                                class="category-card-overlay position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-end p-4">
                                <span class="text-uppercase text-white-50 small fw-medium mb-1"
                                    style="letter-spacing: 1.5px;">ELEGANT WOMENSWEAR</span>
                                <h4 class="fw-bold text-white text-uppercase m-0 mb-3 fs-3"
                                    style="letter-spacing: 1px;">Shop For Women</h4>
                                <div>
                                    <span
                                        class="btn btn-light rounded-pill px-4 py-2 text-uppercase fw-semibold fs-7 shadow-sm d-inline-flex align-items-center gap-2">
                                        Explore Department
                ...
                <div class="col-md-4">
                    <div class="category-card">
                        <a href="#new-arrival" class="d-block text-decoration-none text-white">
                            <img src="{{ asset('images/cat-item3.jpg') }}" alt="Shop Accessories"
                                class="img-fluid w-100 category-card-img">
                            <!-- Item Badge -->
                            <span
                                class="badge bg-white text-dark rounded-pill position-absolute top-0 end-0 m-3 px-3 py-2 fw-semibold shadow-sm"
                                style="font-size: 0.75rem;">22 ITEMS</span>
                            <!-- Gradient Overlay & Content -->
                            <div
                                class="category-card-overlay position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-end p-4">
                                <span class="text-uppercase text-white-50 small fw-medium mb-1"
                                    style="letter-spacing: 1.5px;">ARTISANAL GOODS</span>
                                <h4 class="fw-bold text-white text-uppercase m-0 mb-3 fs-3"
                                    style="letter-spacing: 1px;">Shop Accessories</h4>
                                <div>
                                    <span
                                        class="btn btn-light rounded-pill px-4 py-2 text-uppercase fw-semibold fs-7 shadow-sm d-inline-flex align-items-center gap-2">
                                        Explore Department
                ...
                <div class="swiper-wrapper d-flex">
                        ...
                        <div class="product-item image-zoom-effect link-effect">
                            <div class="image-holder position-relative">
                                <a href="#modalQuickView" data-bs-toggle="modal" data-bs-target="#modalQuickView">
                                    <img src="{{ asset('images/cat-large-item1.jpg') }}"
                                        alt="Silk Pleated Midi Skirt" class="product-image img-fluid"
                                        style="height: 380px; object-fit: cover; width: 100%;">
                                </a>
                                <a href="#" class="btn-icon btn-wishlist"
                                    onclick="event.preventDefault(); showToast('Added to Wishlist! ❤️');">
                                    <svg width="24" height="24" viewBox="0 0 24 24">
                                        <use xlink:href="#heart"></use>
                                    </svg>
                                </a>
                                <div class="product-content">
                                    <h5 class="element-title text-uppercase fs-5 mt-3">
                                        <a href="#modalQuickView" data-bs-toggle="modal"
                                            data-bs-target="#modalQuickView">Silk Pleated Midi Skirt</a>
                                    </h5>
                                    <a href="#modalQuickView" data-bs-toggle="modal"
                                        data-bs-target="#modalQuickView" class="text-decoration-none"
                                        data-after="Add to cart"><span>$88.00</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="image-holder position-relative">
                                <a href="#modalQuickView" data-bs-toggle="modal" data-bs-target="#modalQuickView">
                                    <img src="{{ asset('images/post-image1.jpg') }}"
                                        alt="Oversized Cashmere Blazer" class="product-image img-fluid"
                                        style="height: 380px; object-fit: cover; width: 100%;">
                                </a>
                                <a href="#" class="btn-icon btn-wishlist"
                                    onclick="event.preventDefault(); showToast('Added to Wishlist! ❤️');">
                                ...
                                <div class="product-content">
                                    <h5 class="element-title text-uppercase fs-5 mt-3">
                                        <a href="#modalQuickView" data-bs-toggle="modal"
                                            data-bs-target="#modalQuickView">Oversized Cashmere Blazer</a>
                                    </h5>
                                    <a href="#modalQuickView" data-bs-toggle="modal"
                                        data-bs-target="#modalQuickView" class="text-decoration-none"
                                        data-after="Add to cart"><span>$145.00</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-item image-zoom-effect link-effect">
                            <div class="image-holder position-relative">
                                <a href="#modalQuickView" data-bs-toggle="modal" data-bs-target="#modalQuickView">
                                    <img src="{{ asset('images/post-image4.jpg') }}" alt="Structured Linen Trench"
                                        class="product-image img-fluid"
                                        style="height: 380px; object-fit: cover; width: 100%;">
                                </a>
                                <a href="#" class="btn-icon btn-wishlist"
                                ...
                                <div class="product-content">
                                    <h5 class="element-title text-uppercase fs-5 mt-3">
                                        <a href="#modalQuickView" data-bs-toggle="modal"
                                            data-bs-target="#modalQuickView">Structured Linen Trench</a>
                                    </h5>
                                    <a href="#modalQuickView" data-bs-toggle="modal"
                                        data-bs-target="#modalQuickView" class="text-decoration-none"
                                        data-after="Add to cart"><span>$165.00</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-item image-zoom-effect link-effect">
                            <div class="image-holder position-relative">
                                <a href="#modalQuickView" data-bs-toggle="modal" data-bs-target="#modalQuickView">
                                    <img src="{{ asset('images/product-item-9.jpg') }}"
                                        alt="Satin High-Waist Trousers" class="product-image img-fluid"
                                        style="height: 380px; object-fit: cover; width: 100%;">
                                </a>
                                <a href="#" class="btn-icon btn-wishlist"
                                    onclick="event.preventDefault(); showToast('Added to Wishlist! ❤️');">
                                ...
                                <div class="product-content">
                                    <h5 class="element-title text-uppercase fs-5 mt-3">
                                        <a href="#modalQuickView" data-bs-toggle="modal"
                                            data-bs-target="#modalQuickView">Satin High-Waist Trousers</a>
                                    </h5>
                                    <a href="#modalQuickView" data-bs-toggle="modal"
                                        data-bs-target="#modalQuickView" class="text-decoration-none"
                                        data-after="Add to cart"><span>$78.00</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-item image-zoom-effect link-effect">
                            <div class="image-holder position-relative">
                                <a href="#modalQuickView" data-bs-toggle="modal" data-bs-target="#modalQuickView">
                                    <img src="{{ asset('images/single-image-2.jpg') }}"
                                        alt="Minimalist Wool Knit Vest" class="product-image img-fluid"
                                        style="height: 380px; object-fit: cover; width: 100%;">
                                </a>
                                <a href="#" class="btn-icon btn-wishlist"
                                    onclick="event.preventDefault(); showToast('Added to Wishlist! ❤️');">
                                ...
                                <div class="product-content">
                                    <h5 class="element-title text-uppercase fs-5 mt-3">
                                        <a href="#modalQuickView" data-bs-toggle="modal"
                                            data-bs-target="#modalQuickView">Minimalist Wool Knit Vest</a>
                                    </h5>
                                    <a href="#modalQuickView" data-bs-toggle="modal"
                                        data-bs-target="#modalQuickView" class="text-decoration-none"
                                        data-after="Add to cart"><span>$62.00</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modalQuickView" tabindex="-1" aria-labelledby="modalQuickViewLabel"
        aria-hidden="true">
                    ...
                    <div class="row g-4 align-items-start">
                        ...
                        <div class="col-md-6 text-center">
                            <div class="qv-img-wrapper p-2 bg-light rounded-4 border mb-3 position-relative">
                                ...
                                <img src="{{ asset('images/product-item-5.jpg') }}" id="qvMainImage"
                                    alt="Product Image" class="img-fluid rounded-3 object-fit-cover w-100"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <label class="fw-bold text-dark small text-uppercase"
                                            style="letter-spacing: 1px;">Select Size: <span
                                                ...
                                                id="qvSelectedSize">M</span></label>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <button type="button"
                                            ...
                                            <svg width="16" height="16" viewBox="0 0 24 24"
                                                ...
                                                <line x1="6" y1="7" x2="6"
                                                    y2="12"></line>
                                                <line x1="10" y1="7" x2="10"
                                                    y2="10"></line>
                                                <line x1="14" y1="7" x2="14"
                                                    y2="12"></line>
                                                <line x1="18" y1="7" x2="18"
                                                    y2="10"></line>
                                            </svg>
                    ...
                    <ul class="nav nav-tabs border-0 gap-2" id="profileTabNav" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link d-flex align-items-center gap-2" id="navPrefTab"
                                data-bs-toggle="tab" data-bs-target="#tabPreferences" type="button"
                                role="tab" aria-controls="tabPreferences" aria-selected="false">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2">
                        ...
                        <div class="tab-content" id="profileTabContent">
                            ...
                            <div class="tab-pane fade show active" id="tabPhoto" role="tabpanel"
                                ...
                                <div class="text-center mb-4">
                                    <div class="avatar-upload-wrapper mb-3">
                                        <img src="{{ asset('images/insta-item1.jpg') }}"
                                ...
                                <div class="avatar-dropzone mb-4" id="avatarDropzone"
                                    ...
                                    <small class="text-muted d-block mb-2">or <span
                                            class="text-primary fw-bold">click to browse computer</span></small>
                                </div>
                            ...
                            <div class="tab-pane fade" id="tabContact" role="tabpanel"
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <label
                                            class="form-label text-uppercase fs-7 text-muted fw-medium">City</label>
    ...
    <div class="modal fade" id="modalSizing" tabindex="-1" aria-labelledby="modalSizingLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div
                    ...
                    <ul class="nav nav-tabs border-0 gap-2" id="sizeGuideTabNav" role="tablist">
                        ...
                        <li class="nav-item">
                            <button class="nav-link d-flex align-items-center gap-2 fw-semibold"
                                id="tabSavedPref-tab" data-bs-toggle="tab" data-bs-target="#tabSavedPref"
                    ...
                    <div class="tab-content" id="sizeGuideTabContent">
                        ...
                        <div class="tab-pane fade" id="tabSavedPref" role="tabpanel">
                            <form
                                ...
                                <button type="submit"
                                    class="btn btn-dark w-100 p-3 mt-4 text-uppercase fw-semibold"
            ...
            <div class="container">
                <div class="row g-4 text-center">
                    <div class="col-6 col-md-3">
                        <div
                            class="footer-trust-badge p-3 rounded-3 bg-light border h-100 d-flex flex-column align-items-center justify-content-center">
                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none"
        ...
        <div class="container">
            <div class="row g-4 py-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="pe-lg-4">
                        <div class="footer-intro mb-3">
                            <a href="/">
                                <img src="{{ asset('images/main-logo.png') }}" alt="Kaira Logo"
                                    style="height: 38px;">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    ...
                    <ul class="list-unstyled footer-link-list">
                        <li><a href="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAccount">Track
                                Order Status</a></li>
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#modalProfile">My VIP
                                Profile</a></li>
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#modalContact">Returns &
                                Exchanges</a></li>
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#modalContact">Shipping &
                                Delivery Info</a></li>
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#modalContact">Help Center &
                                FAQs</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex flex-column gap-3 text-secondary" style="font-size: 0.9rem;">
                        <div class="d-flex align-items-start gap-3">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" class="text-primary mt-1 flex-shrink-0">
                                <path
                                    d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z">
                                </path>
                            </svg>
                            <div>
                                ...
                                <a href="tel:+43720115278" class="text-decoration-none text-secondary">+43 720 11 52
                                    78</a>
                            </div>
                        </div>
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div>
                                ...
                                <a href="mailto:support@kaira-fashion.com"
                                    class="text-decoration-none text-secondary">support@kaira-fashion.com</a>
                            </div>
                        </div>
                        <div class="d-flex align-items-start gap-3">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
    ...
    <div class="toast-container-profile">
        <div id="profileToast" class="toast align-items-center text-white bg-success border-0 shadow-lg"

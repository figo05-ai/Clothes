...
@section("content")
            ...
            <div class="row justify-content-center text-center mb-4">
                <div class="col-lg-7 col-md-9" data-aos="fade-up">
                    <span class="text-uppercase text-primary fw-bold d-block mb-1"
                        style="font-size: 0.8rem; letter-spacing: 2.5px;">{{ __('CURATED LOOKBOOK 2026') }}</span>
                    <h2 class="section-title text-uppercase m-0 fw-bold display-6" style="letter-spacing: 1px;">{{ __('NEW COLLECTIONS') }}</h2>
                    <p class="text-secondary mt-3 mx-auto"
                        style="font-size: 0.95rem; line-height: 1.6; max-width: 620px;">
                        {{ __('Discover our curated selection of premium apparel and timeless statement pieces, crafted from sustainable fabrics with meticulous attention to detail.') }}
                    </p>
                </div>
            </div>
                            ...
                            <div class="spotlight-card h-100 d-flex flex-column">
                                <div class="position-relative overflow-hidden">
                                    <a href="{{ $banner->link_url }}" class="d-block text-decoration-none">
                                        <img src="{{ $banner->image_url }}" alt="{{ __($banner->title) }}"
                                ...
                                <div class="p-4 d-flex flex-column flex-grow-1">
                                    <h5 class="fw-bold text-dark text-uppercase mb-2" style="letter-spacing: 0.5px;">
                                        <a href="{{ $banner->link_url }}" class="text-decoration-none text-dark">{{ __($banner->title) }}</a>
                                    </h5>
                                    <div>
                    ...
                    <div class="category-card">
                        <a href="{{ route('frontend.category', $category->slug) }}" class="d-block text-decoration-none text-white">
                            ...
                            <div class="category-card-overlay position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-end p-4">
                                ...
                                <h4 class="fw-bold text-white text-uppercase m-0 mb-3 fs-3" style="letter-spacing: 1px;">{{ __($category->name) }}</h4>
                                <div>
    ...
    <section id="new-arrival" class="new-arrival product-carousel py-5 position-relative overflow-hidden">
        <div class="container">
            <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
                <h4 class="text-uppercase">{{ __('Our New Arrivals') }}</h4>
                <a href="/" class="btn-link">{{ __('View All Products') }}</a>
            </div>
                                ...
                                <div class="image-holder position-relative">
                                    ...
                                    <div class="product-content">
                                        <h5 class="element-title text-uppercase fs-5 mt-3">
                                            <a href="{{ route('frontend.product', $product->slug) }}">{{ __($product->name) }}</a>
                                        </h5>
                                        <a href="#" class="text-decoration-none"
                                            data-after="{{ __('Add to cart') }}"><span>${{ number_format($product->base_price, 2) }}</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container py-3">
            <div class="row align-items-center g-0 collection-card bg-white border">
                ...
                <div class="col-lg-6 col-md-12 p-0 overflow-hidden position-relative" style="min-height: 480px;">
                    <img src="{{ asset('images/single-image-2.jpg') }}" alt="{{ __('Classic Winter Collection') }}"
                    ...
                    <div class="position-absolute top-0 start-0 m-4 z-2">
                        <span
                            ...
                            style="letter-spacing: 2px; font-size: 0.78rem;">{{ __('EDITORIAL CAPSULE 2026') }}</span>
                    </div>
                </div>
                    ...
                    <div class="p-lg-3">
                        ...
                        <div class="row g-3 mb-4 text-dark" style="font-size: 0.85rem;">
                            <div class="col-6 d-flex align-items-center gap-2">
                                ...
                                <span class="fw-semibold">{{ __('100% Italian Wool & Cashmere') }}</span>
                            </div>
                            <div class="col-6 d-flex align-items-center gap-2">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" class="text-primary">
                                ...
                                <span class="fw-semibold">{{ __('Ethically Sourced Fabrics') }}</span>
                            </div>
                            <div class="col-6 d-flex align-items-center gap-2">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" class="text-primary">
                                ...
                                <span class="fw-semibold">{{ __('Tailored Thermal Insulation') }}</span>
                            </div>
                            <div class="col-6 d-flex align-items-center gap-2">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" class="text-primary">
                                ...
                                <span class="fw-semibold">{{ __('Limited Handcrafted Run') }}</span>
                            </div>
                        </div>
    ...
    <section id="best-sellers" class="best-sellers product-carousel py-5 position-relative overflow-hidden">
        <div class="container">
            <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
                <h4 class="text-uppercase">{{ __('Best Selling Items') }}</h4>
                <a href="/" class="btn-link">{{ __('View All Products') }}</a>
            </div>
            <div class="swiper product-swiper open-up" data-aos="zoom-out">
                <div class="swiper-wrapper d-flex">
        ...
        <div class="container">
            <div class="section-header text-center mb-4">
                <span class="text-uppercase text-primary fw-bold"
                    style="font-size: 0.8rem; letter-spacing: 2px;">{{ __('Real Customer Reviews') }}</span>
                <h3 class="section-title text-uppercase m-0 mt-1">{{ __('WE LOVE GOOD COMPLIMENT') }}</h3>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div
                            ...
                            <blockquote class="testimonial-text mb-4"
                                ...
                                “{{ __('The quality of the tailoring is simply extraordinary. The fabric breathes beautifully, and the fit is flattering without feeling restrictive. Truly my favorite online shopping discovery this year!') }}”
                            </blockquote>
                            <div
                                ...
                                <div class="text-start">
                                    ...
                                    <small class="text-success fw-medium" style="font-size: 0.75rem;">{{ __('Verified Buyer') }}
                                        • {{ __('Austria') }}</small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div
                            ...
                            <blockquote class="testimonial-text mb-4"
                                style="font-size: 1.05rem; line-height: 1.7; color: #333; font-style: italic;">
                                “{{ __('I ordered the winter wool overcoat and was blown away by the luxurious feel and attention to detail. Fast global shipping and the packaging felt like opening a luxury gift.') }}”
                            </blockquote>
                            <div
                                class="reviewer-profile d-flex align-items-center justify-content-center gap-3 border-top pt-3">
                    ...
                    <div class="swiper-slide">
                        <div
                            ...
                            <blockquote class="testimonial-text mb-4"
                                style="font-size: 1.05rem; line-height: 1.7; color: #333; font-style: italic;">
                                “{{ __('Unmatched customer service and effortless returns! The knitwear holds its shape perfectly even after multiple washes. Worth every single penny for such timeless wardrobe staples.') }}”
                            </blockquote>
                            <div
                                class="reviewer-profile d-flex align-items-center justify-content-center gap-3 border-top pt-3">
                    ...
                    <div class="swiper-slide">
                        <div
                            ...
                            <blockquote class="testimonial-text mb-4"
                                style="font-size: 1.05rem; line-height: 1.7; color: #333; font-style: italic;">
                                “{{ __('Kaira has completely transformed my daily aesthetic. Clean silhouettes, premium fabrics, and subtle design nuances make these pieces stand out in any professional setting.') }}”
                            </blockquote>
                            <div
                                class="reviewer-profile d-flex align-items-center justify-content-center gap-3 border-top pt-3">
    ...
    <section id="blog" class="blog py-5 bg-white">
        <div class="container">
            <div class="d-flex flex-wrap justify-content-between align-items-end mt-4 mb-4 pb-2 border-bottom">
                <div>
                    <span class="text-uppercase text-primary fw-bold"
                        style="font-size: 0.8rem; letter-spacing: 2px;">{{ __('Editorial Insights') }}</span>
                    <h3 class="section-title text-uppercase m-0 mt-1"
                        style="font-weight: 700; letter-spacing: 1px;">{{ __('READ BLOG POSTS') }}</h3>
                </div>
                <a href="#blog" class="btn-link text-uppercase fw-semibold" style="letter-spacing: 1px;">{{ __('View All Posts →') }}</a>
            </div>
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <article class="blog-card h-100 d-flex flex-column">
                        <div class="blog-img-wrapper">
                            <span class="blog-badge">{{ __('Styling Tips') }}</span>
                            <a href="#blog">
                                <img src="{{ asset('images/post-image1.jpg') }}"
                                    alt="{{ __('How to Look Outstanding in Pastel') }}" class="img-fluid">
                            </a>
                        </div>
                        <div class="blog-content p-4 d-flex flex-column flex-grow-1">
                            <div class="text-uppercase text-muted fw-medium mb-2"
                                ...
                                <span>JUL 11, 2022</span> • <span>5 {{ __('MIN READ') }}</span>
                            </div>
                            <h5 class="fw-bold mb-3" style="font-size: 1.15rem; line-height: 1.4;">
                                <a href="#blog" class="blog-title-link">{{ __('How to Look Outstanding in Pastel') }}</a>
                            </h5>
                            <p class="text-secondary mb-4 flex-grow-1"
                                style="font-size: 0.92rem; line-height: 1.6;">
                                {{ __('Master the delicate art of incorporating muted tones into your seasonal wardrobe. Discover how pairing soft lavender, sage green, and blush pink with neutral tailoring creates a sophisticated silhouette.') }}
                            </p>
                            <div class="border-top pt-3 mt-auto d-flex align-items-center justify-content-between">
                                ...
                                <a href="#blog" class="fw-semibold text-primary text-decoration-none"
                                    style="font-size: 0.85rem;">{{ __('Read Article →') }}</a>
                            </div>
                        </div>
                    </article>
                </div>
                ...
                <div class="col-md-4">
                    <article class="blog-card h-100 d-flex flex-column">
                        <div class="blog-img-wrapper">
                            <span class="blog-badge">{{ __('Trend Report') }}</span>
                            <a href="#blog">
                                <img src="{{ asset('images/post-image2.jpg') }}"
                                    alt="{{ __('Top 10 Fashion Trends for Summer') }}" class="img-fluid">
                            </a>
                        </div>
                        <div class="blog-content p-4 d-flex flex-column flex-grow-1">
                            <div class="text-uppercase text-muted fw-medium mb-2"
                                style="font-size: 0.78rem; letter-spacing: 1px;">
                                <span>JUL 11, 2022</span> • <span>4 {{ __('MIN READ') }}</span>
                            </div>
                            <h5 class="fw-bold mb-3" style="font-size: 1.15rem; line-height: 1.4;">
                                <a href="#blog" class="blog-title-link">{{ __('Top 10 Fashion Trends for Summer') }}</a>
                            </h5>
                            <p class="text-secondary mb-4 flex-grow-1"
                                style="font-size: 0.92rem; line-height: 1.6;">
                                {{ __('From lightweight linen ensembles and oversized tailoring to breathable open-weave knits, explore the top curated trends dominating runway shows and urban street style this season.') }}
                            </p>
                            <div class="border-top pt-3 mt-auto d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-2">
                ...
                <div class="col-md-4">
                    <article class="blog-card h-100 d-flex flex-column">
                        <div class="blog-img-wrapper">
                            <span class="blog-badge">{{ __('Editorial') }}</span>
                            <a href="#blog">
                                <img src="{{ asset('images/post-image3.jpg') }}"
                                    alt="{{ __('Crazy Fashion with Unique Moment') }}" class="img-fluid">
                            </a>
                        </div>
                        <div class="blog-content p-4 d-flex flex-column flex-grow-1">
                            <div class="text-uppercase text-muted fw-medium mb-2"
                                style="font-size: 0.78rem; letter-spacing: 1px;">
                                <span>JUL 11, 2022</span> • <span>6 {{ __('MIN READ') }}</span>
                            </div>
                            <h5 class="fw-bold mb-3" style="font-size: 1.15rem; line-height: 1.4;">
                                <a href="#blog" class="blog-title-link">{{ __('Crazy Fashion with Unique Moment') }}</a>
                            </h5>
                            <p class="text-secondary mb-4 flex-grow-1"
                                style="font-size: 0.92rem; line-height: 1.6;">
                                {{ __('Uncover the inspiration behind our latest limited-edition capsule collection. We explore how bold architectural lines and vintage textures blend to create standout statement garments.') }}
                            </p>
                            <div class="border-top pt-3 mt-auto d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-2">
                                    <img src="{{ asset('images/insta-item3.jpg') }}" alt="Sophia Laurent"
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10 text-center">
                    <div class="newsletter-card p-4 p-md-5 bg-light rounded-4 border shadow-sm">
                        <span class="text-uppercase text-primary fw-bold d-block mb-2"
                            style="font-size: 0.8rem; letter-spacing: 2px;">{{ __('Join the Kaira VIP Club') }}</span>
                        <h3 class="section-title text-uppercase m-0 mb-3"
                            style="font-weight: 700; letter-spacing: 1px;">{{ __('SIGN UP FOR OUR NEWSLETTER') }}</h3>
                        <p class="text-secondary mb-4 mx-auto"
                            style="max-width: 580px; font-size: 0.95rem; line-height: 1.6;">
                            {{ __('Subscribe to receive 15% off your first luxury order, exclusive access to capsule collection launches, and private editorial invites.') }}
                        </p>
                        <form id="form" class="newsletter-form mx-auto" style="max-width: 540px;"
                            ...
                            <div class="input-group input-group-lg shadow-sm rounded-pill overflow-hidden border">
                                ...
                                <button type="submit" class="btn btn-dark px-4 fs-6 text-uppercase fw-semibold"
                                    style="letter-spacing: 1px;">{{ __('Subscribe') }}</button>
                            </div>
                        </form>
                        <div class="mt-3 text-muted" style="font-size: 0.78rem;">
                            <span>{{ __('🔒 We respect your privacy. Unsubscribe anytime.') }}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="instagram py-5 bg-light position-relative overflow-hidden">
        <div class="container text-center mb-4">
            <span class="text-uppercase text-primary fw-bold d-block mb-1"
                style="font-size: 0.8rem; letter-spacing: 2px;">{{ __('@KAIRAMODE ON INSTAGRAM') }}</span>
            <h3 class="section-title text-uppercase m-0" style="font-weight: 700; letter-spacing: 1px;">
                {{ __('#KAIRACOLLECTIVE') }}</h3>
        </div>

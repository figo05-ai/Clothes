                ...
                <div class="col-md-4">
                    <div class="category-card">
                        <a href="{{ route('frontend.category', $category->slug) }}" class="d-block text-decoration-none text-white">
                            <img src="{{ $category->icon ?? 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=600&q=80' }}" alt="{{ $category->name }}"
                                class="img-fluid w-100 category-card-img" style="height: 400px; object-fit: cover;">
